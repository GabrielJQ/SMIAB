...
export const Sidebar: React.FC = () => {
    ...
    if (loadingPrinters) return (
        <div className="w-full md:w-80 h-full bg-white/80 backdrop-blur-2xl border-2 border-guinda-700/15 rounded-[2.5rem] p-4 flex items-center justify-center font-medium text-slate-400 italic shadow-xl shadow-slate-200/50">
            Cargando...
        </div>
    );

    return (
        <aside className="w-full md:w-80 md:h-full bg-white/80 backdrop-blur-2xl border-2 border-guinda-700/15 rounded-[2.5rem] flex flex-col shadow-xl shadow-slate-200/50 z-10 shrink-0 overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="px-3 py-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1 bg-transparent">EQUIPOS DE IMPRESIÓN</div>
