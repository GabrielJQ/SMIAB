    ...
    return (
        <DashboardCard className="flex flex-col justify-between min-h-[300px]">
            ...
            <div className="flex items-center justify-between relative z-10">
                ...
                <span className={`text-[10px] font-black text-emerald-600 bg-emerald-50 border border-emerald-100 px-3 py-1.5 rounded-full flex items-center gap-2 shadow-sm ${isFetching ? 'animate-pulse' : ''}`}>
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 mb-6 relative z-10 min-h-[140px]">
                <div className="bg-white/60 backdrop-blur-sm border border-slate-200/60 p-4 rounded-2xl text-center shadow-sm transition-transform hover:scale-105 flex flex-col justify-center items-center h-full group">
                    <div className="text-5xl font-black text-slate-800 leading-none mb-2 group-hover:scale-110 transition-transform duration-300">{currentStats.total}</div>
                ...
                <div className="bg-emerald-50/50 border border-emerald-100/50 p-4 rounded-2xl text-center shadow-sm transition-transform hover:scale-105 flex flex-col justify-center items-center h-full group">
                    <div className="text-5xl font-black text-emerald-600 leading-none mb-2 group-hover:scale-110 transition-transform duration-300">{currentStats.online}</div>
                ...
                <div className="bg-red-50/50 border border-red-100/50 p-4 rounded-2xl text-center shadow-sm transition-transform hover:scale-105 flex flex-col justify-center items-center h-full group">
                    <div className="text-5xl font-black text-red-600 leading-none mb-2 group-hover:scale-110 transition-transform duration-300">{currentStats.offline}</div>
